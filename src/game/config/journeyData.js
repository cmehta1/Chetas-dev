...
export const SKILLS_DATA = [
    // Zone 1: School
    { key: 'maths_1', id: 'maths', label: 'Maths', zone: 1, proficiency: 3 },
    { key: 'science_1', id: 'science', label: 'Science', zone: 1, proficiency: 3 },
    { key: 'socialscience_1', id: 'socialscience', label: 'Social Science', zone: 1, proficiency: 2 },
    { key: 'chemistry_1', id: 'chemistry', label: 'Chemistry', zone: 1, proficiency: 2 },
    { key: 'physics_1', id: 'physics', label: 'Physics', zone: 1, proficiency: 3 },

    // Zone 2: College (GTU) — B.E. Computer Science
    { key: 'algorithms_2', id: 'algorithms', label: 'Algorithms', zone: 2, proficiency: 3 },
    { key: 'dsa_2', id: 'dsa', label: 'Data Structures', zone: 2, proficiency: 3 },
    { key: 'compsec_2', id: 'compsec', label: 'Computer Security', zone: 2, proficiency: 2 },
    { key: 'java_2', id: 'java', label: 'Java', zone: 2, proficiency: 2 },
    { key: 'javascript_2', id: 'javascript', label: 'JavaScript', zone: 2, proficiency: 1 },
    { key: 'c_2', id: 'c', label: 'C', zone: 2, proficiency: 2 },
    { key: 'cplusplus_2', id: 'cplusplus', label: 'C++', zone: 2, proficiency: 3 },
    { key: 'sql_2', id: 'sql', label: 'SQL', zone: 2, proficiency: 2 },

    // Zone 4: Masters (SUNY Binghamton) — M.S. Computer Science
    { key: 'java_4', id: 'java', label: 'Java', zone: 4, proficiency: 3 },
    { key: 'comparch_4', id: 'comparch', label: 'Computer Architecture', zone: 4, proficiency: 3 },
    { key: 'os_4', id: 'os', label: 'Operating Systems', zone: 4, proficiency: 3 },
    { key: 'algorithms_4', id: 'algorithms', label: 'Algorithms', zone: 4, proficiency: 4 },
    { key: 'databases_4', id: 'databases', label: 'Databases', zone: 4, proficiency: 3 },
    { key: 'javascript_4', id: 'javascript', label: 'JavaScript', zone: 4, proficiency: 3 },
    { key: 'react_4', id: 'react', label: 'React', zone: 4, proficiency: 2 },
    { key: 'c_4', id: 'c', label: 'C', zone: 4, proficiency: 3 },

    // Zone 5: Midway Dental Supply
    { key: 'python_5', id: 'python', label: 'Python', zone: 5, proficiency: 3 },
    ...
    { key: 'react_6', id: 'react', label: 'React', zone: 6, proficiency: 3 },
    { key: 'sql_6', id: 'sql', label: 'SQL', zone: 6, proficiency: 4 },

    // Zone 7: Oracle Health
    { key: 'java_7', id: 'java', label: 'Java', zone: 7, proficiency: 5 },
    { key: 'react_7', id: 'react', label: 'React', zone: 7, proficiency: 5 },
    { key: 'typescript_7', id: 'typescript', label: 'TypeScript', zone: 7, proficiency: 4 },
    { key: 'mcp_7', id: 'mcp', label: 'MCP', zone: 7, proficiency: 3 },
    { key: 'agents_7', id: 'agents', label: 'Agents', zone: 7, proficiency: 3 },
    { key: 'codex_7', id: 'codex', label: 'Codex', zone: 7, proficiency: 3 },
    { key: 'a2ui_7', id: 'a2ui', label: 'A2UI', zone: 7, proficiency: 3 },
];
